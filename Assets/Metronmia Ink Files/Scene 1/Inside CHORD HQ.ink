Game opens to the commander on the left of the screen, and Dolph on the right of the screen. # context # null # CHORD Commander Dolph
...
Chord Commander’s model is dragged off screen to the left. 7A, Grugg, and The Professor are dragged into the scene from the left, replacing where the commander stood. (Try to space them out evenly if possible) # context # CHORD Commander # 7A Grugg The Prof.
