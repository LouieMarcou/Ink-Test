...
The screen changes to where the first landmass is and the professor is on screen (This should be as simple as changing the background with the sprite already there) 7A should also be visible The professor should be on the left of the screen, 7A should be on the right side Text Box in the middle # null # null # 7A
...
Dolph enters from the right side being dragged in/appearing # null # null # Dolph
